...
RELEASE_VERSIONS := 1.1.5 1.2.0 1.2.1 1.2.2 1.2.3 1.2.4 1.2.5 1.3.0 1.3.1 1.3.3 1.4.0 1.4.1 1.4.2 1.4.3 1.4.4
VERSIONS := $(RELEASE_VERSIONS) master

# Enable DLC for these versions
DLC_VERSIONS := 1.3.0 1.3.1 1.3.3 1.4.0 1.4.1 1.4.2 1.4.3 1.4.4
